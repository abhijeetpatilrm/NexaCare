  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-[#1A2238] mb-4">Professional Home Repair Services</h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Trust our skilled professionals to handle all your home maintenance and repair needs with quality service and expertise.
        </p>
      </div>

      <div className="flex justify-between items-center mb-8">
        <h2 className="text-2xl font-bold text-[#1A2238]">Our Top Services</h2>
        <button 
